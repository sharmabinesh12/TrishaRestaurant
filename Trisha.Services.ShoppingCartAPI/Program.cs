...
using Trisha.Services.ShoppingCartAPI;
using Trisha.Services.ShoppingCartAPI.DbContexts;
using Trisha.Services.ShoppingCartAPI.Repository;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Trisha.Services.ShoppingCartAPI", Version = "v1" });
    c.EnableAnnotations();

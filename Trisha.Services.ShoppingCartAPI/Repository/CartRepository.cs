...
using Trisha.Services.ShoppingCartAPI.DbContexts;
using Trisha.Services.ShoppingCartAPI.Models;
using Trisha.Services.ShoppingCartAPI.Models.Dto;

namespace Trisha.Services.ShoppingCartAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        {
            var test = await _db.CartHeader.FirstOrDefaultAsync(u => u.UserId == userId);
            Cart cart = new()
            {
